...
#define   APM6818_HYBAL_NUM_TAPS            5
#define   APM6818_YFLTR_FIR_NUM_TAPS       18
#define   APM6818_YFLTR_IIR1_NUM_TAPS       1
#define   APM6818_YFLTR_IIR2_NUM_TAPS       5
#define   APM6818_YFLTR_BLOCK_SIZE         28
#define   APM6818_RX_EQ_NUM_TAPS           80
#define   APM6818_TX_EQ_NUM_TAPS           80 
#define   APM6818_ASRC_DEC_NUM_TAPS       120
#define   APM6818_ASRC_INT_NUM_TAPS       120
...
#define   CIC_INC_SHFT_SHIFT              3
     ...
     uint32 reg_cha_asrc_dec_config;                // (0x40) please check reset value
#define   ASRC_DEC_SCALE                  0x0000ffff    //16 bit 2's complement scale value channel a
#define   ASRC_DEC_SCALE_SHIFT            0
#define   ASRC_DEC_SCALE_FACTOR           32 / 25       //conversion factor relative to nominal value
...
#define   RING_OFFSET                     0x0000ffff    //
#define   RING_OFFSET_SHIFT               0

#define   RING_SCALE                      0xffff0000    //
#define   RING_SCALE_SHIFT                16
...
#define   RING_CREST_FACTOR               0x00070000    //3 bit crest factor
#define   RING_CREST_FACTOR_SHIFT         16

#define   RING_GEN_ENABLE_A               0x00100000    //1=enabled
#define   RING_GEN_ENABLE_A_SHIFT         20

#define   RING_GEN_ENABLE_B               0x01000000    //1=enabled
#define   RING_GEN_ENABLE_B_SHIFT         24

  uint32        reg_ring_config_3;                      // (0x98)
#define   RING_BREAK_PHASE_A              0x000000ff    //break phase
#define   RING_BREAK_PHASE_A_SHIFT        0

#define   RING_BREAK_PHASE_B              0x0000ff00    //break phase
#define   RING_BREAK_PHASE_B_SHIFT        8
...
#define   SER_MUX_SEL                     0x00000003	/* kevin, where this from? 6816, 6828 6818 rdb are same*/
...
#define   APM_OTP_TRIM                    0x00000FC0// kevin where this info from?
...
#define  PCM_EXTCLK_SEL          0x00010000     // PCM external timing clock select -- Maybe removed in 6818
#define  PCM_EXTCLK_SEL_SHIFT    16
#define  PCM_NTR_ENABLE          0x00008000     // PCM NTR counter enable -- Nayve removed in 6818
...
#define   PCM_NCO_SOFT_INIT               0x00000080
    ...
    uint32        reserved;													//(0x21c)
    uint32        pcm_zds_intf;                    // (0x220)ZSI Config register ( New in 6818 )
    uint32        pcm_msif_intf;                   // (0x224)ISI Config register ( New in 6818 )
...
#define  PCM_MAX_TIMESLOT_REGS   16             // Number of PCM time slot registers in the table.
    ...
    uint32 pcm_slot_alloc_tbl[PCM_MAX_TIMESLOT_REGS];//(0x240-0x27c)PCM Slot Allocation Table
#define  PCM_TS_VALID            0x8            // valid marker for TS alloc ram entry
} PcmControlRegisters;

#define PCM ((volatile PcmControlRegisters * const) PCM_BASE)
//kevin add pcm for 6818 getting from 6828 cfg

typedef struct HvgControlRegisters
{
   uint16        reg_hvg_scale_vtip;				/* HVG_BASE_REG_0, Condition Scale: V_hvg, and V_tip*/
   uint16        reg_hvg_scale_vhvg;

   uint16        reg_hvg_scale_vloop;				/* HVG_BASE_REG_1, Condition Scale: V_ring and I_loop*/
   uint16        reg_hvg_scale_vring;

   uint16        reg_hvg_scale_vcal;				/* HVG_BASE_REG_2, Condition Scale: V_input and Cal*/
   uint16        reg_hvg_scale_vinput;

   uint16        reg_hvg_offset_vtip;				/* HVG_BASE_REG_3, Condition Offset: V_hvg and V_tip*/
   uint16        reg_hvg_offset_vhvg;

   uint16        reg_hvg_offset_vloop;			/* HVG_BASE_REG_4, Condition Offset: V_ring and I_loop */
   uint16        reg_hvg_offset_vring;

   uint16        reg_hvg_offset_vcal;				/* HVG_BASE_REG_5, Condition Offset: V_input and Cal*/
   uint16        reg_hvg_offset_vinput;

   uint32        reg_hvg_shift;							/* HVG_BASE_REG_6, Condition Shift: Shifts, soft_init, trim source, ignore reset, diode_drop*/
...
#define   HVG_SOFT_INIT                   0x40000000
   ...
   uint32        reg_hvg_track_max;				/* HVG_BASE_REG_7, Track Max: Off-Hook and Ring-Tracking*/
#define   RING_TRACK_MAX                  0x00000fff
#define   OFF_HOOK_MAX                    0x0fff0000

   uint32        reg_hvg_duty_cycle;			/* HVG_BASE_REG_8, Duty Cycle: Max/Min Duty Cycle Min_on_time, SC-thrshold*/
...
#define   SHORT_CIRCUIT_THSHLD            0xff000000
   ...
   uint32        reg_hvg_ring;						/* HVG_BASE_REG_9, Ring Track Config: Ring_gain, Ring_ovhd, common_ring_ref*/
...
#define   PULSE_START_PHASE               0xff000000
   ...
   uint32        reg_hvg_bg;							/* HVG_BASE_REG_11, BG_TRIM: BG_trim, ring_delay, ser_tst_inject, turns_ratio */
...
#define   HVG_TURNS_RATIO                 0xFFC00000

   uint32        reg_hvg_vbat;						/*HVG_BASE_REG_12 - V-bat conditioning: Vbat scale, offset, shift*/
#define   SCALE_V_BAT                     0x00007fff
#define   OFFSET_V_BAT                    0x0fff8000
#define   SHIFT_V_BAT                     0xf0000000

   uint32        reg_hvg_status1;					/*HVG_BASE_STATUS_1 - V_hvg_inst: V_hvg_inst, valid, oob*/
...
#define   HVG_INST_A                      0x00001fff
   ...
   uint32        reg_hvg_status2;					/*HVG_BASE_STATUS_2 - V_tip_inst: V_tip_inst, valid, oob*/
...
#define   TIP_INST_A                      0x00001fff
   ...
   uint32        reg_hvg_status3;					/*HVG_BASE_STATUS_3 - V_ring_inst: V_ring_inst, valid, oob*/
...
#define   RING_INST_A                     0x00001fff
   ...
   uint32        reg_hvg_status4;					/*HVG_BASE_STATUS_4 - I_loop_inst: I_loop_inst, valid, oob*/
...
#define   LOOP_INST_A                     0x00001fff
   ...
   uint32        reg_hvg_status5;					/*HVG_BASE_STATUS_5 - V_input_inst: V_input_inst, valid, oob*/
...
#define   INPUT_INST_A                    0x00001fff
   ...
   uint32        reg_hvg_status6;					/*HVG_BASE_STATUS_6 - Cal_inst: Cal_inst, valid, oob*/
...
#define   CAL_INST_A                      0x00001fff
   ...
   uint32        reg_hvg_status7;					/*HVG_BASE_STATUS_7 - Flags_err: Duty_cycle, SC_flags, OOB, arbiter_err*/
...
#define   AVG_BLOCK_DONE_A                0x00000001
   ...
   uint32        reg_hvg_status8;					/*HVG_BASE_STATUS_8 - V_hvg_A_avg*/
...
#define   HVG_MEAN                        0x001fffff
   ...
   uint32        reg_hvg_status10;				/*HVG_BASE_STATUS_10 - V_tip_A_avg*/
...
#define   TIP_MEAN                        0x001fffff
   ...
   uint32        reg_hvg_status12;				/*HVG_BASE_STATUS_12 - V_ring_A_avg*/
...
#define   RING_MEAN                       0x001fffff
   ...
   uint32        reg_hvg_status14;				/*HVG_BASE_STATUS_14 - V_tp_rg_A_avg*/
...
#define   TP_RG_MEAN                      0x001fffff
   ...
   uint32        reg_hvg_status16;				/*HVG_BASE_STATUS_16 - I_loop_A_avg*/
...
#define   I_LOOP_MEAN                     0x001fffff
   ...
   uint32        reg_hvg_status18;				/*HVG_BASE_STATUS_18 - V_input_A_avg*/
...
#define   INPUT_MEAN                      0x001fffff
   ...
   uint32        reg_hvg_status20;				/*HVG_BASE_STATUS_20 - Cal_A_avg*/
...
#define   CAL_MEAN                        0x001fffff
   ...
   uint32        reg_hvg_status35;				/*HVG_BASE_STATUS_35 - Cal_B_mn_sqr, 		Address Offset = 32'h1020_03bc*/	

   uint32        reg_hvg_aux0;						/* kevin pls verify with chip team */
#define   BMU_HVG_ADC_CLK_MODE            0x20000000
   uint32        reg_hvg_aux1;
   uint32        reg_hvg_aux2;
   uint32        reg_hvg_aux3;

   uint32        hvg_spacer1[12];

   uint32        reg_hvg_cha_window_ctrl;/*HVG_BASE_REG_13 - Channel A Window Control, Address Offset = 32'h1020_0400 */
...
#define   NEW_BLK_RQST                    0x20000000
   ...
   uint16        reg_hvg_cha_max_hvg_slic;		/*HVG_BASE_REG_14 -upper 16 bits Channel A constant voltage goal*/
   uint16        reg_hvg_cha_const_volt_goal;	/*HVG_BASE_REG_14 -lower 16 bits Channel A constant voltage goal*/

   uint32        reg_hvg_cha_misc;				/*HVG_BASE_REG_15 - Channel A Misc*/
...
#define   HVG_MODE_ONHOOK_FIXED           0x00002000/* constant voltage mode */
#define   HVG_MODE_OFFHOOK_FASD           0x00003000/* not define */
...
#define   HVG_RR_SINGLE                   0x00008000
   ...
   uint16        reg_hvg_chb_max_hvg_slic;/* kevin, why it has upper/lower 16 bits? */
   uint16        reg_hvg_chb_const_volt_goal;

   uint32        reg_hvg_chb_misc;
   uint32        reg_hvg_chb_spare;
   
   uint32        reg_hvg_zar_if_config;/* kevin where are these 4 addresses from?*/
   uint32        reg_hvg_zar_if_xmt_data;
   uint32        reg_hvg_zar_status_21;
   uint32        reg_hvg_zar_status_22;
   
} HvgControlRegisters;

#define HVG ((volatile HvgControlRegisters * const) APM_HVG_BASE)

/***** TBD. This is the BCM6368 definition.  Need BCM6818 definition. *****/
...
#define BCM6818_MAX_PCM_DMA_CHANNELS 2

typedef struct PcmIudma
{
   PcmIudmaRegisters regs;                                        //
   uint32 reserved1[52];                                          //
   PcmIudmaChannelCtrl ctrl[BCM6818_MAX_PCM_DMA_CHANNELS];        //
   uint32 reserved2[40];                                          //
   PcmIudmaStateRam stram[BCM6818_MAX_PCM_DMA_CHANNELS];          //

} PcmIudma;

#define PCM_IUDMA ((volatile PcmIudma * const) PCM_DMA_BASE)

//kevin added...... for apmpcmiudma/apmpcmiudmaregister/apmpcmiudmachannelctrl/apmpcmiudmastateram
...
typedef struct ApmPcmIudma
{
   ...
   uint32 reserved1[52];                                             //
   ApmPcmIudmaChannelCtrl ctrl[BCM6818_MAX_APM_PCM_DMA_CHANNELS];    //
   uint32 reserved2[40];                                             //
   ApmPcmIudmaStateRam stram[BCM6818_MAX_APM_PCM_DMA_CHANNELS];      //

} ApmPcmIudma;

#define APM_PCM_IUDMA ((volatile ApmPcmIudma * const) APM_PCM_DMA_BASE)
//kevin added...... for apmpcmiudma/apmpcmiudmaregister/apmpcmiudmachannelctrl/apmpcmiudmastateram---end
/*
