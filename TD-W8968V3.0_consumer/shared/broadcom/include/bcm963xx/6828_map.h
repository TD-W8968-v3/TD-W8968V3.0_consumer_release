...
#define  PCM_EXTCLK_SEL          0x00010000     // PCM external timing clock select -- Maybe removed in 6828
#define  PCM_EXTCLK_SEL_SHIFT    16
#define  PCM_NTR_ENABLE          0x00008000     // PCM NTR counter enable -- Nayve removed in 6828
...
typedef struct ApmPcmIudma
{
   ...
   uint32 reserved1[52];                                             //
   ApmPcmIudmaChannelCtrl ctrl[BCM6828_MAX_APM_PCM_DMA_CHANNELS];    //
   uint32 reserved2[40];                                             //
   ApmPcmIudmaStateRam stram[BCM6828_MAX_APM_PCM_DMA_CHANNELS];      //
