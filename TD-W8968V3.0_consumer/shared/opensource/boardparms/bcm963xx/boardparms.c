...
enum bp_id {
  ...
  bp_usGPioBtnWireless, /* add by wwj 130407 */
  bp_usGpioUsbLed,
  bp_last
};
...
static bp_elem_t * g_BoardParms[] = {g_bcm96362advnx, g_bcm96362advngr, g_bcm96362advngr2, g_bcm963629epon, g_bcm96362advn2xh, g_bcm96361XF, g_bcm96361I2, g_bcm96362rpvt, g_bcm96362rpvt_2u, g_bcm96362ravngr2, g_bcm96362advn2xm, g_bcm96362radvnxh5, g_bcm96362radvn2xh, g_bcm96362radvnxh5_p203, 0};
#endif
...
static bp_elem_t g_bcm96818g_rg[] = {
  ...
  {bp_usSpeedLed100,           .u.us = BP_SERIAL_GPIO_4_AL},
  {bp_usSpeedLed1000,          .u.us = BP_SERIAL_GPIO_5_AL},  
  {bp_ulPhyId2,                .u.ul = 0x18 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ulPhyId3,                .u.ul = 0x19 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ulPhyId4,                .u.ul = 0xff | PHYCFG_VALID}, /* WAN interface */
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0}, 
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_7_AL},
...
static bp_elem_t g_bcm96818egg[] = {
  ...
  {bp_ulPhyId2,                .u.ul = 0x08 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_MII},
  {bp_pPhyInit,                .u.phyinitp = g_phyinit_ac201led},
  {bp_ulPhyId3,                .u.ul = 0x10 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_MII},
  {bp_pPhyInit,                .u.phyinitp = g_phyinit_ac201led},
  {bp_ulPhyId4,                .u.ul = 0xff | PHYCFG_VALID}, /* WAN interface */
  {bp_ulPhyId5,                .u.ul = 0x18 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
...
static bp_elem_t g_bcm96818grrg[] = {
  ...
  {bp_usSpeedLed100,           .u.us = BP_SERIAL_GPIO_4_AL},
  {bp_usSpeedLed1000,          .u.us = BP_SERIAL_GPIO_5_AL},
  {bp_ulPhyId2,                .u.ul = 0x19 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ulPhyId3,                .u.ul = 0x1A | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ulPhyId4,                .u.ul = 0xff | PHYCFG_VALID}, /* WAN interface */
  {bp_ulPhyId5,                .u.ul = 0x18 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,            .u.uc = 0},
  ...
  {bp_usGpioLaserReset,        .u.us = BP_GPIO_1_AL}, /* GRRG board has the optical module reset pin connecting to GPIO 1*/
  {bp_usGponOpticsType,        .u.us = BP_GPON_OPTICS_TYPE_LEGACY},
  {bp_last}
};
...
static bp_elem_t g_bcm96818gr_ont[] = {
  ...
  {bp_ulExtIntrMocaHostIntr,       .u.ul = BP_EXT_INTR_SHARED | BP_EXT_INTR_3}, // May have to pin mux this as well?   
#endif  
  ...
  {bp_usSpeedLed100,               .u.us = BP_SERIAL_GPIO_1_AL},
  {bp_usSpeedLed1000,              .u.us = BP_SERIAL_GPIO_0_AL}, 
  {bp_ulPhyId2,                    .u.ul = 0xA | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  ...
  {bp_usGponOpticsType,            .u.us = BP_GPON_OPTICS_TYPE_BOSA},
  {bp_usGpioSpiSlaveReset,         .u.us = BP_GPIO_24_AH},
...
//  {bp_usGpio_Intr,                 .u.us = BP_GPIO_25_AL},
 // {bp_usExtIntrResetToDefault,     .u.us = BP_EXT_INTR_SHARED | BP_EXT_INTR_3},
//  {bp_usGpio_Intr,                 .u.us = BP_GPIO_5_AL},
//  {bp_ulExtIntrMocaHostIntr,       .u.ul = BP_EXT_INTR_SHARED | BP_EXT_INTR_3},   
#endif  
  {bp_ucPhyType0,                  .u.uc = BP_ENET_EXTERNAL_SWITCH},
  {bp_ucPhyAddress,                .u.uc = 0x0},
  {bp_usConfigType,                .u.us = BP_ENET_CONFIG_MMAP},
  ...
  {bp_usPhyConnType,               .u.us = PHY_CONN_TYPE_MOCA},  
  {bp_ucPhyDevName,                .u.cp = "moca%d"},  
  {bp_ulPhyId3,                    .u.ul = 0xA | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
  {bp_usPhyConnType,               .u.us = PHY_CONN_TYPE_MOCA_ETH},  
  {bp_ucPhyDevName,                .u.cp = "eth%d"},  
  {bp_ucDspType0,                  .u.uc = BP_VOIP_MIPS},
  {bp_ucDspAddress,                .u.uc = 0},  
...
static bp_elem_t * g_BoardParms[] = {g_bcm96818sv, g_bcm96818sv_miiOverGpio, g_bcm96818g_rg, g_bcm96818g_rg_bosa, g_bcm96812brg, g_bcm96812brg_bosa, g_bcm96818egg, g_bcm96812r2g, g_bcm96818grrg, g_bcm96818grrg_bosa, g_bcm96818gr_ont, g_bcm6802SV, g_bcm96818egg_p202, 0};
...
static bp_elem_t g_bcm963168xm5[] = {
    ...
    {bp_ulPhyId2,                .u.ul = BP_PHY_ID_3},
    {bp_ulPhyId3,                .u.ul = BP_PHY_ID_4},
    {bp_ulPhyId4,                .u.ul = 0x18 | PHY_INTEGRATED_VALID | PHY_EXTERNAL | MAC_IFACE_VALID | MAC_IF_RGMII},
    {bp_ucDspType0,              .u.uc = BP_VOIP_MIPS},
    {bp_ucDspAddress,            .u.uc = 0},
    {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_4_AL},
    {bp_usGpioVoip2Led,          .u.us = BP_SERIAL_GPIO_5_AL},
...
static bp_elem_t * g_BoardParms[] = {g_bcm963268sv1, g_bcm963268mbv, g_bcm963168vx, g_bcm963168vx_p300, g_bcm963268bu, g_bcm963268bu_p300,
		...
		g_bcm963168vx_p400, g_bcm963168vx_ext1p8, g_bcm963168ach5, g_bcm963168xn5, g_bcm963168xm5, g_bcm963168xm5_6302, 0};
...
static bp_elem_t g_bcm96828sv_temp[] = {
  ...
  {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_USB_DEVICE | BP_OVERLAY_HS_SPI_SSB6_EXT_CS)},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_DISABLE_LED_INVERSION},
  ...
  {bp_ulNumVoipPorts,          .u.ul = 2},
  {bp_cpPersonalityName,	   .u.cp = "Pers_Test1"}, 
  {bp_last}
};
...
static bp_elem_t g_bcm96828hgw[] = {
  ...
  {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_SERIAL_LEDS |
                                       ...
                                       BP_OVERLAY_GPHY_LED_1)},
  {bp_ulDeviceOptions,         .u.ul = BP_DEVICE_OPTION_DISABLE_LED_INVERSION},
  {bp_usGpioLedEpon,           .u.us = BP_GPIO_47_AL},
  {bp_usGpioLedEponFail,       .u.us = BP_GPIO_48_AL},
  {bp_usGpioLedSesWireless,    .u.us = BP_SERIAL_GPIO_5_AL},
  {bp_usGpioLedWanData,        .u.us = BP_GPIO_46_AL},
  {bp_usGpioLedWanError,       .u.us = BP_SERIAL_GPIO_2_AL},
  ...
  {bp_usGpioEponOpticalSD,     .u.us = BP_GPIO_41_AH},
  {bp_cpPersonalityName,	   .u.cp = "Pers_Standard"},
  {bp_last}
};
...
static bp_elem_t g_bcm96828f_hgw[] = {
  ...
  {bp_usGpioI2cSda,            .u.us = BP_GPIO_45_AH},
  {bp_usGpioEponOpticalSD,     .u.us = BP_GPIO_41_AH},
  {bp_cpPersonalityName,	   .u.cp = "Pers_FlowControlOff"},
  {bp_last}
};
...
#endif
  {bp_cpPersonalityName,	   .u.cp = "Pers_SFU"},
  {bp_last}
};
...
static bp_elem_t g_bcm96828egg[] = {
  {bp_cpBoardId,               .u.cp = "96828EGG"},
  {bp_ulGpioOverlay,           .u.ul =(BP_OVERLAY_GPHY_LED_0 |
                                       BP_OVERLAY_GPHY_LED_1 |
                                       BP_OVERLAY_EPHY_LED_0 |
                                       BP_OVERLAY_EPHY_LED_1 |
  ...
  {bp_usGpioVoip1Led,          .u.us = BP_SERIAL_GPIO_3_AL},
  {bp_usGpioVoip2Led,          .u.us = BP_SERIAL_GPIO_4_AL},
  {bp_ulNonPeriphGpioCtrlMap,  .u.ul = 0xE1F600},/* GPIO 37-40 and 43, 49-52 are occupied by voice SLIC Le9530*/
  {bp_usGpioI2cScl,            .u.us = BP_GPIO_44_AH},
  {bp_usGpioI2cSda,            .u.us = BP_GPIO_45_AH},
  {bp_usGpioEponOpticalSD,     .u.us = BP_GPIO_41_AH},
  {bp_cpPersonalityName,	   .u.cp = "Pers_Standard"},
...
static bp_elem_t g_bcm96828egg_p202[] = {
  {bp_cpBoardId,               .u.cp = "96828EGG_P202"},
  {bp_usGpioLedEponFail,       .u.us = BP_GPIO_49_AL},
  {bp_elemTemplate,            .u.bp_elemp = g_bcm96828egg},
  {bp_last}
};
static bp_elem_t * g_BoardParms[] = {g_bcm96828sv, g_bcm96828hgw, g_bcm96828f_hgw, g_bcm96828g_hgw, g_bcm96821f_hgw, g_bcm96821g_hgw, g_bcm96821f_sfu, g_bcm96821g_sfu, g_bcm96821f_sfu21, g_bcm96821g_sfu21, g_bcm96828sv_temp, g_bcm96828egg, g_bcm96828egg_p202, 0};
...
static bp_elem_t g_bcm96318ref[] = {
  ...
  {bp_usGpioLedWanData,        .u.us = BP_GPIO_8_AL},
//  {bp_usGpioLedWanError,       .u.us = BP_GPIO_9_AL}, /* GPIO 9 for wifi button by wwj */
  {bp_usGpioLedBlStop,         .u.us = BP_GPIO_11_AL},
  {bp_usExtIntrResetToDefault, .u.us = BP_EXT_INTR_1},
  {bp_usExtIntrSesBtnWireless, .u.us = BP_EXT_INTR_0},
  {bp_usAntInUseWireless,      .u.us = BP_WLAN_ANT_MAIN},
  ...
  {bp_ucDspAddress,            .u.uc = 0},
  {bp_ulAfeId0,                .u.ul = BP_AFE_CHIP_INT | BP_AFE_LD_6301 | BP_AFE_FE_ANNEXA | BP_AFE_FE_AVMODE_ADSL | BP_AFE_FE_REV_6301_REV_5_1_3},
  {bp_usGPioBtnWireless,       .u.us = BP_GPIO_9_AL}, /* add by wwj 130407 */
  {bp_usGpioUsbLed,            .u.us = BP_GPIO_13_AL},
  {bp_last}
};
...
static bp_elem_t * g_BoardParms[] = {g_bcm96318sv, g_bcm96318ref, g_bcm96318ref_p300, g_bcm96318sv_serled, g_bcm96318sv_sersw, 0};
...
{
	return ( BpGetGpio(bp_usGPioBtnWireless, pusValue ) );
} /* BpGetWirelessBtnGpio */

int BpGetUsbLedGpio( unsigned short *pusValue )
{
	return ( BpGetGpio(bp_usGpioUsbLed, pusValue ) );
} /* BpGetWirelessBtnGpio */
