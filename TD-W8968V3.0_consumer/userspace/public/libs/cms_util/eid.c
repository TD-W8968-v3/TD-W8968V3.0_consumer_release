...
{EID_OSGID,        /* eid */
   ...
   {EID_IPSEC,
    ...
    EIF_LAUNCH_ON_BOOT|EIF_MDM|EIF_MESSAGING_CAPABLE,/* flags */
    0,				  /* backlog for TCP server port */
    0,				  /* TCP/UDP server port */
#ifdef SUPPORT_IPSEC
    TRUE,				
   ...
   {EID_RTT,
    0,				  /* TR69 attribute access bit */
    "BIAManufactoryRfTest",
    "/bin/BIAManufactoryRfTest",
    "",				  /* run args (don't daemonize) */
    EIF_LAUNCH_ON_BOOT,/* flags */
    0,				  /* backlog for TCP server port */
    0,				  /* TCP/UDP server port */
    TRUE,				
    0, 0, 0},		  /* misc memory parameters */
...
//Hanjiayan add
   {EID_USB_DEGRADE,
    ...
    "/bin/usbDegrade",
    "",				  /* run args (don't daemonize) */
    EIF_LAUNCH_ON_BOOT|EIF_AUTO_RELAUNCH,/* flags */
    0,				  /* backlog for TCP server port */
    0,				  /* TCP/UDP server port */
#ifdef SUPPORT_USB_DEGRADE
    TRUE,				
#else 
    FALSE,
#endif
...
//Hanjiayan add for usb 3G
   {EID_HANDLE_CARD,
    ...
    "/bin/handle_card",
    "",				  /* run args (don't daemonize) */
    EIF_MESSAGING_CAPABLE|EIF_MULTIPLE_INSTANCES,/* flags */
    0,				  /* backlog for TCP server port */
    0,				  /* TCP/UDP server port */
