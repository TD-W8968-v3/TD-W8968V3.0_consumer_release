...
typedef enum
{
   ...
   CMSRET_FOLDER_EXCEEDED = 9856,

   CMSRET_AUTH_FAILED = 9857,
...
/* added by pj for usb 3g interface */
#define USB_3G_USB_IFC_STR	    "ttyUSB"
#define USB_3G_ACM_IFC_STR	    "ttyACM"
#define USB_3G_IFC_STR 			"tty"
